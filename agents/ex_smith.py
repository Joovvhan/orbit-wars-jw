...
F14_4A_2P_FOCUS_DIST_BONUS = 28.0   # BEAST: heavy focus on lone enemy in 2P   
F14_4A_2P_FOCUS_HAMMER_BONUS = 35.0   # BEAST: hammer enemy much harder in 2P
F14_4A_2P_FOCUS_MEGA_BONUS = 150   # BEAST: mega-hammer focus bonus in 2P
...
FWD_SIM_HORIZON = 10   # BEAST: deeper lookahead             
...
SEARCH_MAX_PER_SOURCE = 4   # BEAST: consider more targets per source       
SEARCH_MAX_ACTIONS_TO_PICK = 9   # BEAST: commit more actions per turn    
SEARCH_MAX_ACTIONS_TO_PICK_2P = 14   # BEAST: more actions in 2P 
...
TERMINAL_PHASE_TURNS = 45   # BEAST: longer kill-phase at end

FLEET_INTENT_ENABLED = True
FLEET_INTENT_MIN_DROP = 5   # BEAST: detect enemy launches earlier       
...
MELIS_SANITY_THETA = 1.5   # BEAST: fire on weaker opportunities
...
PSM_OPENING_TURN = 14
PSM_OPENING_TURN_2P = 10   # BEAST: start tactical play earlier in 2P    
...
EXPAND_K_OPENING = 3   # BEAST: target 3 planets per source in opening             
EXPAND_K_MID = 2   # BEAST: target 2 planets per source in mid-game                 
EXPAND_MAX_TRAVEL_OPENING = 24   # BEAST: reach farther in opening
EXPAND_MAX_TRAVEL_MID = 18   # BEAST: reach farther in mid-game
EXPAND_MIN_MARGIN = 0            
EXPAND_MIN_MARGIN_4P = 3  


X8B_2P_EXTRA = 5   # BEAST: send more ships for 2P expansion
...
VALUE_WEIGHT_2P = 6.5   # BEAST: value production much more in 2P
...
ANTI_SNIPE_HORIZON = 18   # BEAST: less paranoid—allow more attacks          
...
CHEAP_PICKUP_MAX_GARRISON = 33   # BEAST: pick up more cheap neutrals
...
NEUTRAL_TEMPO_THRESHOLD = 6   # BEAST: less conservative tempo filter     
...
WEAKEST_TARGET_BONUS = 5.0   # BEAST: ruthlessly target weakest enemy      
...
LEADER_BASH_RATIO = 1.15   # BEAST: bash the leader earlier
LEADER_BASH_BONUS = 7.5   # BEAST: stronger leader bash incentive
LEADER_BASH_MIN_STEP = 45   # BEAST: start bashing leader sooner   
...
HAMMER_ENABLED = True
HAMMER_STOCKPILE_MIN = 38   # BEAST: hammer with smaller stockpile
HAMMER_TARGET_PROD_MIN = 2
HAMMER_PROD_SHARE_TRIGGER = 0.33   # BEAST: hammer fires earlier
HAMMER_OVERKILL_RATIO = 1.18   # BEAST: more efficient—fire sooner
HAMMER_SURROUNDED_PROMOTE_TURNS = 6   # BEAST: promote idling planets to hammers faster  
HAMMER_MAX_TRAVEL = 30   # BEAST: hammer over longer distances                
HAMMER_ABORT_OVERRUN_RATIO = 1.18   # BEAST: keep firing longer before abort     
HAMMER_PLAN_REVALIDATE_INTERVAL = 1   
HAMMER_MIN_PER_CONTRIBUTOR = 7   # BEAST: allow smaller contributors        
...
MEGA_HAMMER_SHIPS_MIN = 230   # BEAST: mega-hammer with fewer ships           
MEGA_HAMMER_TARGET_GARRISON_MAX = 105   # BEAST: target harder fortified planets  
MEGA_HAMMER_MAX_TRAVEL = 50   # BEAST: mega-hammer over longer ranges           
...
MEGA_HAMMER_THRESHOLD_BY_PROD = {5: 140, 4: 180, 3: 230, 2: 270, 1: 310}   # BEAST: lower thresholds → hammer fires sooner
...
MEGA_HAMMER_SHIPS_MIN_FRESH = 150   # BEAST: fresh captures: lower threshold          
...
ACCUMULATOR_LEAD_MIN_SHIPS = 75   # BEAST: accumulate with fewer ships            
ACCUMULATOR_LEAD_THREAT_RATIO = 0.5         
ACCUMULATOR_FEEDER_MIN_SURPLUS = 18   # BEAST: more aggressive feeding         
ACCUMULATOR_FEEDER_KEEP_RESERVE = 30        
ACCUMULATOR_FEEDER_MAX_TRAVEL = 30          
ACCUMULATOR_MAX_FEEDS_PER_TURN = 5   # BEAST: feed more planets per turn          
...
MULTIPRONG_ENABLED = True   # BEAST: UNLEASH the two-prong attack!  
...
RACE_ENABLED = True
RACE_HORIZON_TURNS = 24   # BEAST: plan races further ahead          
RACE_MAX_NEUTRAL_DIST = 27   # BEAST: race for farther neutrals     
...
MODE_PARAMS = {  # BEAST: all modes turbocharged
    "patient": {
        "expand_k_opening": 3,            
        "expand_max_travel_opening": 24,  
        "expand_k_mid": 2,
        "expand_max_travel_mid": 18,
        "hammer_prod_share": 0.14,
        "hammer_overkill": 1.15,
        "hammer_stockpile_min": 35,       
    },
    "opportunistic": {
        "expand_k_opening": 4,            
        "expand_max_travel_opening": 24,  
    ...
    "pressure": {
        ...
        "expand_max_travel_opening": 24,  
        "expand_k_mid": 1,
        "expand_max_travel_mid": 12,      
        "hammer_prod_share": 0.20,        
        "hammer_overkill": 1.08,          
...
MODE_PARAMS_2P = {  # BEAST: 2P is full aggression
    "patient": {
        "expand_k_opening": 7,            
        "expand_max_travel_opening": 40,  
        "expand_k_mid": 6,                
        "expand_max_travel_mid": 34,      
        "hammer_prod_share": 0.20,        
        "hammer_overkill": 1.08,          
        "hammer_stockpile_min": 16,       
    },
    "opportunistic": {
        "expand_k_opening": 8,
        "expand_max_travel_opening": 40,
        "expand_k_mid": 8,
        "expand_max_travel_mid": 36,
        "hammer_prod_share": 0.18,
        "hammer_overkill": 1.08,
        "hammer_stockpile_min": 16,
    },
    "pressure": {
        ...
        "expand_max_travel_opening": 40,
        "expand_k_mid": 4,
        "expand_max_travel_mid": 58,      
        "hammer_prod_share": 0.15,        
        "hammer_overkill": 1.05,
        "hammer_stockpile_min": 14,
    },
}
...
TWO_P_PATIENT_NUDGE_TURNS = 7   # BEAST: escalate patience to action faster
TWO_P_PATIENT_ESCALATE_TURNS = 13   # BEAST: escalate to pressure mode faster
...
STOP_EXPAND_PROD_SHARE_2P = 0.72   # BEAST: need bigger lead before stopping expand    
...
PROD_LAG_STOP_EXPAND_THRESH_2P = 0.34   # BEAST: keep expanding even while lagging   
...
ENEMY_TEMPO_STOP_EXPAND_MIN_LAUNCHES = 4   # BEAST: harder to scare off expansion
